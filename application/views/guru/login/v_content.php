                ...
                <div class="card-body login-card-body">
                  ...
                  <form action="<?= base_url() ?>guru/login" method="post">
                    <div class="input-group mb-3">
                      <input type="number" name="nip" class="form-control" placeholder="NIP" required="" required="">
                    ...
                    <div class="input-group mb-3">
                      <input type="password" name="password" class="form-control" placeholder="Password (NIP)" required="">
                      <div class="input-group-append">
                        <div class="input-group-text">
