	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
					...
					?>
					<form action="<?= base_url() ?>guru/login" method="post">
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="number" name="nip" autocomplete="off" placeholder="NIP" required="" required="">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Password is required">
						<input class="input100" type="password" name="password" autocomplete="off" placeholder="Password (NIP)" required="">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
