									...
									<div class="m-widget19__header">
										...
										<div class="m-widget19__info">
											<span class="m-widget19__username">
												<b style="font-size: 14px;"><?= $data_guru->nama_guru ?></b>
											</span>
											<br>
							...
							<div class="row">
								...
								<div class="col-xl-3">
									<div class="dbox dbox--color-1">
										...
										<div class="dbox__body">
											...
											<span class="dbox__title">MAPEL DIAMPU</span>
										</div>

										<div class="dbox__action">
											<a href="<?= base_url() ?>guru/mapel" class="btn m-btn--pill btn-secondary m-btn m-btn--custom dbox__action__btn">Lihat Detail</a>
										</div>				
									</div>
								</div>
								<!-- ./col -->
								<div class="col-xl-3">
									<div class="dbox dbox--color-2">
										...
										<div class="dbox__action">
											<a href="<?= base_url() ?>guru/siswa" class="btn m-btn--pill btn-secondary m-btn m-btn--custom dbox__action__btn">Lihat Detail</a>
										</div>				
									</div>
								</div>
								<!-- ./col -->
					...
					<div class="box">
						<div class="box-body">
							...
							<?php if (isset($data_guru->rombel)): ?>
								<p class="m-badge m-badge--danger m-badge--wide">Anda adalah wali kelas <b><?= $data_guru->rombel ?></b></p>
							<?php endif ?>
							<p></p>
						</div>
					</div>
