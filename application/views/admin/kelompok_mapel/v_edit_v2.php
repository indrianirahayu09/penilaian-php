				...
				<div class="m-portlet m-portlet--mobile">
					<div class="m-portlet__body">
						...
						<div>
							...
							?>
							<form action="<?= base_url() ?>admin/kelompok_mapel/edit/<?= $detail->id_kelompok_mapel ?>" method="post">
								<div class="row">
									<div class="form-group col-md-12">
										<label for="">Kode Kelompok</label>
										<input type="text" name="kode" value="<?= $detail->kelompok ?>" class="form-control" placeholder="Kode Kelompok" required="">
									</div>
									<div class="form-group col-md-12">
										<label for="">Nama Kelompok</label>
										<input type="text" name="nama" value="<?= $detail->nama_kelompok ?>" class="form-control" placeholder="Nama Kelompok" required="">
									</div>
								</div>
