									...
									<div class="m-widget19__header">
										...
										<div class="m-widget19__info">
											<span class="m-widget19__username">
												<b style="font-size: 14px;"><?= $data_wali->nama_wali ?></b>
											</span>
											<br>
					...
					<div class="box">
						<div class="box-body">
							...
							<?php if (isset($data_wali->rombel)): ?>
								<p>Anda adalah Orang Tua/Wali dari siswa <b class="m-badge m-badge--danger m-badge--wide"><?= $data_wali->nama_siswa ?></b> kelas <b class="m-badge m-badge--info m-badge--wide"><?= $data_wali->rombel ?></b></p>
							<?php endif ?>
							<p></p>
						</div>
					</div>
