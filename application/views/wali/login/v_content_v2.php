			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
					<center>
						...
						<span class="login100-form-title p-b-55">
							Login Sebagai Orang Tua/Wali Siswa
						</span>
					</center>
					<br>
					<?php  
					...
					?>
					<form action="<?= base_url() ?>wali/login" method="post">
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="text" name="telepon" autocomplete="off" placeholder="Telepon" required="" required="">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Password is required">
						<input class="input100" type="password" name="password" autocomplete="off" placeholder="Password (Telepon)" required="">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
