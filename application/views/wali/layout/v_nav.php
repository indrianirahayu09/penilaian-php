  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse order-3" id="navbarCollapse">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a href="<?= base_url() ?>wali/rapot" class="nav-link">E-Rapot</a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url() ?>siswa/nilai/list" class="nav-link">Pelanggaran</a>
        </li>
      </ul>
    </div>
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <?php if (empty($data_wali->foto_wali)): ?>
            ...
            <?php else: ?>
              <img src="<?= base_url() ?>public/media/upload-wali/<?= $data_wali->foto_wali ?>" class="user-image img-circle elevation-2" alt="User Image">
            <?php endif ?>
            <span class="d-none d-md-inline"><?= $data_wali->nama_wali ?></span> <i class="fa fa-chevron-down"></i>
          </a>
          <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <li class="user-header bg-primary">
              <?php if (empty($data_wali->foto_wali)): ?>
                ...
                <?php else: ?>
                  <img src="<?= base_url() ?>public/media/upload-wali/<?= $data_wali->foto_wali ?>" class="img-circle elevation-2" alt="User Image">
                <?php endif ?>
                <p>
                  <?= $data_wali->nama_wali ?>
              ...
              <li class="user-footer">
                ...
                <a href="<?= base_url() ?>wali/login/logout" class="btn btn-default btn-flat float-right">Keluar</a>
              </li>
            </ul>
          </li>
