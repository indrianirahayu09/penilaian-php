        ...
        <div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-dark m-aside-header-menu-mobile--submenu-skin-dark "  >
          <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
            <li class="m-menu__item "  aria-haspopup="true">
              <a  href="<?= base_url() ?>wali/dashboard" class="m-menu__link ">
            ...
            <li class="m-menu__item "  aria-haspopup="true">
              <a  href="<?= base_url() ?>wali/rapot" class="m-menu__link ">
            ...
            <li class="m-menu__item "  aria-haspopup="true">
              <a  href="<?= base_url() ?>wali/pelanggaran" class="m-menu__link ">
                <i class="m-menu__link-icon fa fa-warning"></i>
                <span class="m-menu__link-text">
                  Pelanggaran
                </span>
              </a>
            ...
            <li class="m-menu__item "  aria-haspopup="true">
              <a  href="<?= base_url() ?>wali/grafik_nilai" class="m-menu__link ">
              ...
              <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click" aria-expanded="true">
                <a href="#" class="m-nav__link m-dropdown__toggle">
                  <span class="m-topbar__userpic">
                    <?php if (empty($data_wali->foto_wali)): ?>
                      <img src="<?= base_url() ?>public/media/icon/no-img.jpg" class="--img-rounded m--marginless m--img-centered" alt="User Image">
                      <?php else: ?>
                        <img src="<?= base_url() ?>public/media/upload-wali/<?= $data_wali->foto_wali ?>" class="u--img-rounded m--marginless m--img-centered" alt="User Image">
                      <?php endif ?>
                  </span>
                      ...
                      <div class="m-card-user m-card-user--skin-dark">
                        <div class="m-card-user__pic">
                          <?php if (empty($data_wali->foto_wali)): ?>
                            ...
                            <?php else: ?>
                              <img src="<?= base_url() ?>public/media/upload-wali/<?= $data_wali->foto_wali ?>" class="m--img-rounded m--marginless" alt="User Image">
                            <?php endif ?>
                        </div>
                      ...
                      <div class="m-dropdown__content">
                        <ul class="m-nav m-nav--skin-light">
                          <li class="m-nav__item">
                            <a href="<?= base_url() ?>wali/profil" class="m-nav__link">
                          ...
                          <li class="m-nav__item">
                            <a href="<?= base_url() ?>wali/login/logout" class="btn m-btn--pill btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder"><i class="m-nav__link-icon fa fa-share-square-o"></i>
                              Keluar
                            </a>
                          </li>
                        </ul>
